...
const (
	...
	AuthService_Authentication_FullMethodName = "/auth.AuthService/Authentication"
)
...
type AuthServiceClient interface {
	Registration(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*AuthResponse, error)
...
func (c *authServiceClient) Registration(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
...
func (c *authServiceClient) Authentication(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
...
type AuthServiceServer interface {
	Registration(context.Context, *UserRequest) (*AuthResponse, error)
...
func (UnimplementedAuthServiceServer) Registration(context.Context, *UserRequest) (*AuthResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method Registration not implemented")
}
func (UnimplementedAuthServiceServer) Authentication(context.Context, *UserRequest) (*AuthResponse, error) {
